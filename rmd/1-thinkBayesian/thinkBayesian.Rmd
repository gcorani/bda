...
\bigskip
  ...
  * The frequentist interpretation of probability is the long-run relative frequency of a repeatable event.
...
* Bayesian analysis would answer the first question, by  assessing the uncertainty of the hypothesis, in light of the data.

\bigskip

* A  frequentist analysis would answer the second question, by assesssin the uncertainty of the  data in light of an assumed hypothesis.

# Probability of having the disease, given the positive test
...
* This is the Bayesian answer: it measures the uncertainty of an hypothesis, given the observed data.
...
*  Since only 9 of the 96 people without the disease tested positive, there’s a roughly 10% (9/96) chance that you would’ve tested positive even if you didn’t have the disease. 
