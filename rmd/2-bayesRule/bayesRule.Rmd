...
* $B$ = you just finished reading a book from a certain author and you enjoyed it.
\bigskip

* $A$ = you will also enjoy the newest novel from the same author.


# $P(B|A)>P(B)$ or $P(B|A)<P(B)$?

* $B$ = it’s 0 degrees Celsius tonight. \bigskip
...
* Marginal and conditional probability are identical.
...
* Unobserved variable $A$, whose set of possible states is denoted by $\mathcal{A}$.

\bigskip

* Observable variable $B$ 
...
Requires:
  ...
  *  prior distribution  $P(A)$ \bigskip
  
  *  conditional distribution $P(B|A)$ \bigskip

* Given $B=b$, the posterior distribution  of $A$ is: 
...
\frac{P(A)P(A \mid b)}{\sum_{a \in \mathcal{A}} P(a,b)} \\
& P(b)>0
\end{align*}
