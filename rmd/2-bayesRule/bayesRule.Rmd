...
* Consider a slight modification of the previous setup.

\bigskip

* You pick a coin (either the rigged or the fair one) and you  toss it twice.

\bigskip

* The first toss is head; the posterior distribution of the coin being rigged is  as in the previous exercise: 1/3 fair, 2/3 rigged.

\bigskip

* Update this posterior with the outcome of the  second toss, which is tails.
  * Which is the probability of the coin being rigged?
...
* Let us assume you choose door 1 and the presenter open door 3.
...
$$P(O_3 \mid D_1), P(O_3 \mid D_2), P(O_3 \mid D_3)$$.
...
* If the car is behind door 2, the presenter will surely open door 3: 
$$P(O_3 \mid D_2)=1$$

\bigskip

* If the car is behind door 3, the presenter will never open door 3: 
$$P(O_3 \mid D_3)=0$$
...
\begin{align*}
P(D_1 \mid O_3) & = \frac{P(D_1) P(O_3 \mid D_1)}{P(O_3)}\\
\end{align*}
...
$$ P(O_3) =
P(O_3 \mid D_1) P(D_1) + P(O_3 \mid D_2) P(D_2) + P(O_3 \mid D_3) P(D_3)
$$
...
\begin{align*}
P(D_1 \mid O_3) & = \frac{P(O_3 \mid D_1)}
{P(O_3 \mid D_1) + P(O_3 \mid D_2)  + P(O_3 \mid D_3)}\\
& = \frac{1/2}{3/2} = 1/3
\end{align*}

# Posterior probability of $D_2$
* The posterior probability of $D_3$ is obviously 0 (it has been opened).
...
\begin{align*}
P(D_2 \mid O_3) & = \frac{P(O_3 \mid D_3)}
{P(O_3 \mid D_1) + P(O_3 \mid D_2)  + P(O_3 \mid D_3)}\\
& = \frac{1}{3/2} = 2/3
\end{align*}
