...
* Thus both  prior and posterior  assigns zero probability to any $\pi$ \textgreater 0.25.
the posterior model must also assign zero probability to any value in that range.
