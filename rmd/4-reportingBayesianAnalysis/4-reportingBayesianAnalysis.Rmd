...
* *Slightly informative*  priors are recommended, for instance limiting the parameter values only to the positive range, or to a certain order or magnitude, etc. 
...
* The HDI could (not always) be split into two sub-intervals, one for each mode of the distribution. 
...
* In this case  you can use the numerical procedure of arviz in order to compute the HDI.